/**
 * ============================================
 * VERSANT - FORMATION DES ÉQUIPES (SOURCE UNIQUE)
 * ============================================
 * Module UMD partagé entre le backend (require) et le frontend (global window).
 * C'est LA source de vérité pour formBalancedTeams : le backend fige les équipes
 * et le frontend les affiche/simule ; ils DOIVENT produire un résultat identique
 * pour un même seed. Ce fichier remplace les anciennes copies divergentes de
 * backend/team-utils.js et public/js/config.js.
 *
 * Servi au navigateur depuis /shared/team-formation.js (racine = public/).
 * Requis côté backend via ../public/shared/team-formation.js.
 */
(function (root, factory) {
  const api = factory();
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = api;            // backend (CommonJS)
  } else {
    root.TeamFormation = api;        // navigateur (global)
  }
  ...
  return { TEAM_COLORS, seededRandom, evaluateStdDev, formBalancedTeams };
});
